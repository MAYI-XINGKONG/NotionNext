        ...
        <div id='footer-container' className='w-full mx-auto max-w-screen-xl'>
            ...
            <div id='footer-copyright-wrapper' className='flex flex-col md:flex-row justify-between border-t border-gray-600 pt-8'>
                <div className='text-start space-y-1'>
                    ...
                    {/* 技术支持 */}
                    <div className='text-xs text-light-500 dark:text-gray-700'>Powered by <a href='https://github.com/MAYI-XINGKONG/NotionNext' className='dark:text-gray-300'>NotionNext {siteConfig('VERSION')}</a>.</div>
